...
<!-- ZEROPS:REFLOG -->
### 2026-08-09 — Bootstrap: Provision 5 Zerops services for "Nomad" — frontend (static Vite), api (Fastify), worker (syslog+diagnosis+remediation), db (managed Postgres), target (demo app) as npm-workspaces monorepo per docs/03-technical-spec-and-file-structure.md

- **Runtime:** frontend (static@1.0, simple)
- **Runtime:** api (nodejs@22, simple)
- **Dependencies:** db (postgresql:single@18)
- **Runtime:** worker (nodejs@22, simple)
- **Dependencies:** db (postgresql:single@18)
- **Runtime:** target (nodejs@22, simple)
- **Session:** 990a394044691727
